<template>
  <v-main class="recursos-shell">
    <LoadingScreen
      ...
      status-message="Cargando biblioteca de recursos..."
    />
    ...
    <v-container class="recursos-container">
      ...
      <header class="recursos-header">
        ...
        <h1 class="recursos-title">
          Recursos Externos <span class="accent-dot">.</span>
        </h1>
        <p class="recursos-subtitle">
          Amplía tu conocimiento con nuestra seleccion curada de documentos,
          videos y sitios web especializados.
        </p>
      </header>
      ...
      <v-window v-model="activeTab" class="resources-window">
        ...
        <v-window-item value="pdf">
          <v-row>
            <v-col
              v-for="(pdf, index) in resources.pdfs"
              :key="index"
              cols="12"
              md="6"
              lg="4"
        ...
        <v-window-item value="video">
          <v-row>
            <v-col
              v-for="(vid, index) in resources.videos"
              :key="index"
              cols="12"
              md="6"
            >
        ...
        <v-window-item value="web">
          <v-row>
            <v-col
              v-for="(web, index) in resources.webs"
              :key="index"
              cols="12"
              md="6"
              lg="4"
...
const resources = {
  pdfs: [
    ...
    },
    {
      ...
      description:
        "Artículo científico sobre el papel del carbono en la vida vegetal.",
      link: "#",
    },
    {
  ...
  videos: [
    ...
    },
    {
      ...
      thumbnail:
        "https://images.unsplash.com/photo-1501004318641-729e8e26bd05?q=80&w=1974&auto=format&fit=crop",
...
.parallax-bg::before {
  ...
  background: linear-gradient(
    135deg,
    rgba(128, 161, 36, 0.12) 0%,
    rgba(221, 174, 56, 0.12) 50%,
